...
static void mpegts_write_pat(AVFormatContext *s)
{
    ...
    //av_log(NULL, AV_LOG_INFO, "write pat.\r\n");
...
static int mpegts_write_pmt(AVFormatContext *s, MpegTSService *service)
{
    ...
    for (i = 0; i < s->nb_streams; i++) {
        ...
        //av_log(s, AV_LOG_WARNING, "write pmt stream type:0x%02x, pid:%d.\r\n", stream_type, ts_st->pid);
        *q++ = stream_type;
    ...
    //av_log(NULL, AV_LOG_INFO, "write pmt.\r\n");
...
static void mpegts_write_sdt(AVFormatContext *s)
{
    ...
    *q++ = 0xff;
    ...
    //av_log(NULL, AV_LOG_INFO, "write sdt.\r\n");
