...
static const StreamType REGD_types[] = {
    ...
    { MKTAG('V', 'p', '8', '0'), AVMEDIA_TYPE_VIDEO, AV_CODEC_ID_VP8   },
    { MKTAG('V', 'p', '9', '0'), AVMEDIA_TYPE_VIDEO, AV_CODEC_ID_VP9   },
    { 0 },
};
...
static int new_pes_packet(PESContext *pes, AVPacket *pkt)
{
    ...
    if (pes->total_size != MAX_PES_PAYLOAD &&
        ...
        PES_START_SIZE) {
        av_log(pes->stream, AV_LOG_WARNING, "PES packet size mismatch pes_header_size:%d, \
data_index:%d, total_size:%d, PES_START_SIZE:%d\n",
